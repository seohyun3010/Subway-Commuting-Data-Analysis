...
## 8. 아쉬웠던 점 및 배운 점 
프로젝트 기간 중 다른 일정과 겹치면서 두 차례의 멘토링에 모두 참여하지 못한 점은 아쉬움으로 남습니다. 전문가 피드백을 통해 분석 방향을 보완하고, 다양한 데이터를 추가적으로 활용해 결론을 더욱 정교하게 다듬을 수 있었을 것이라 생각합니다. 그러나 단순히 데이터 분석에 그치지 않고, 분석 결과를 바탕으로 원고를 직접 작성해보는 과정을 통해 데이터를 활용한 스토리텔링의 구조와 전달 방식을 배울 수 있었습니다. 데이터를 어떻게 해석하고, 어떤 흐름으로 풀어내야 설득력 있는 메시지가 되는지 고민해볼 수 있었던 의미 있는 경험이었습니다. 또한 마지막 콘텐츠 공유회를 통해 다양한 사회 문제를 각기 다른 관점에서 바라보고 토론하는 시간을 가지며, 데이터 분석이 사회적 맥락과 연결될 때 더욱 가치가 높아진다는 점을 체감했습니다. 향후에는 노인 이용 시간대 데이터를 추가로 분석하여 정책 효과를 보다 정량적으로 검증하고, 근거 기반의 결론을 더욱 강화해보고 싶습니다.
